...
export default function Contact() {
  ...
  return (
    <div id="contact" className="flex flex-col  ml-11 mt-1 mb-11 px-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center">
        ...
        <div className="card flex flex-col p-6 md:px-11 md:mx-11 mx-2 w-12/12 lg:w-5/12">
            <form ref={form} onSubmit={handleSubmit}>
              <Slide direction="left" triggerOnce>
                ...
                <button type='submit' id="button" name="button" className="submitbtn py-2 px-4  ">
                  Send Message
                </button>
              </Slide>
            </form>
        </div>
        <div className="bio hidden md:block p-4 lg:p-11  mb-20 lg:pt-11 lg:ml-11 w-12/12 lg:w-6/12 lg:mr-11">
          <Slide direction="up">

            <h1 className=" font-bold text-3xl text-red-700 border-b-2 pb-2 text-center">Contact Me </h1>
            
            <div className="flex items-center justify-center">
              
                  <FontAwesomeIcon icon={faPhoneAlt} color='crimson'  className='mt-7 mr-3 glyphicon' />
                  <span className="text-sm md:text-lg text-white mt-6 font-semibold text-center">Phone Number :- (+91) 9572155813</span>
            </div>
            <div className="flex items-center justify-center">
              <Link href='https://www.google.com/gmail/' target='_blank'>
                <a className="text-white font-semibold mt-3 text-center">
                  <FontAwesomeIcon icon={faGoogle} color='crimson'  className='mt-7 mr-3 glyphicon' />
                  <span className=" text-sm md:text-lg" >Email :- raktimyoddha012@gmail.com</span>
                </a>
              </Link>
            </div>
          </Slide>
        ...
        <div className="bio md:hidden p-4 lg:p-11  mt-6 lg:pt-11 lg:ml-11 w-12/12 lg:w-6/12 lg:mr-11">
          <Slide direction="up">
            ...
            <h1 className=" font-bold text-3xl text-red-600 border-b-2 pb-2 text-center">Contact Me @</h1>
            
            <div className="flex items-center justify-center">
                  <span className="text-xs md:text-lg text-white mt-6 font-semibold text-center">Phone Number :- (+91) 9572155813</span>
            </div>
            <div className="flex items-center justify-center">
              <Link href='https://www.google.com/gmail/' target='_blank'>
                <a className="text-white font-semibold mt-3 text-center">
                  <span className=" text-xs md:text-lg" >Email :- raktimyoddha012@gmail.com</span>
                </a>
              </Link>
            </div>
          </Slide>
